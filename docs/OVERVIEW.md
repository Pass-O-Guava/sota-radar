# 📋 SOTA Radar 完整模型列表（2026-04-06 最终版）

> **分类原则**：按「许可证类型 + 模态」双重维度分类，开源/闭源绝不混列  
> **数据截止**：2026-04-06 | **来源**：HuggingFace + ModelScope + 官方博客 实地核查
...
| 3 | **Voxtral TTS** | Mistral AI | 2026-03-26 | voxtral-tts | 首个前沿质量开源权重TTS模型；4.1B参数，支持最少3秒参考音频克隆 |
| 4 | **Qwen3-ASR-0.6B** | 阿里巴巴 | 2026-01-29 | qwen3-asr | 语音识别；0.6B/1.7B双规格 |
